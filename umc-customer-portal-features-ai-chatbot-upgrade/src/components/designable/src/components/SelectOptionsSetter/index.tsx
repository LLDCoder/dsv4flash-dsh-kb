...
const DEFAULT_OPTIONS: SelectOptionItem[] = [
...
const SelectOptionsSetter: React.FC<SelectOptionsSetterProps> = ({
  ...
  const [options, setOptions] = useState<SelectOptionItem[]>(DEFAULT_OPTIONS);
  ...
  const findDefaultIndex = useCallback(
    (opts: SelectOptionItem[], def: string | undefined): number => {

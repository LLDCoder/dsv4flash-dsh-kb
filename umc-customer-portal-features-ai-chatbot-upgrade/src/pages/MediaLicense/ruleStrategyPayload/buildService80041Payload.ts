...
import type { Service80041RuleStrategyValidatePayload } from "@/services/services";
...
const SERVICE_80041_RULE_VERSION = "1.0.0";
...
export const buildService80041Payload = ({
  config,
  formValuesList,
  currentProfileId,
  userInfo,
  submissionMode = "submit",
}: BuildServiceRuleStrategyPayloadParams): Service80041RuleStrategyValidatePayload => {
  return {
    actionType: 3,
    expectedRuleVersion: SERVICE_80041_RULE_VERSION,
    request: {

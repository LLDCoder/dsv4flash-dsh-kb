...
import { getLanguages, type Service202RuleStrategyValidatePayload } from "@/services/services";
...
export const buildService202Payload = async ({
  config,
  formValuesList,
  currentProfileId,
  userInfo,
  submissionMode = "submit",
}: BuildServiceRuleStrategyPayloadParams): Promise<Service202RuleStrategyValidatePayload> => {

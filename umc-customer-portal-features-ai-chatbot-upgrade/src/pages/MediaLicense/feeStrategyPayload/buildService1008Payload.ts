...
export const buildService1008FeePayload = async (
  params: BuildServiceFeeStrategyPayloadParams,
): Promise<FeeQuoteEnvelope> => {
  const enginePayload = await buildService1008FeeEnginePayload(params);
...
export const buildService1008FeeEnginePayload = async ({
  config,
  currentProfileId,
  userInfo,

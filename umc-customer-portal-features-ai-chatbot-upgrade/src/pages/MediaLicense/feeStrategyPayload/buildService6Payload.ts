...
export const buildService6FeePayload = async (
  params: BuildServiceFeeStrategyPayloadParams,
): Promise<FeeQuoteEnvelope> => {
  const enginePayload = await buildService6FeeEnginePayload(params);
...
export const buildService6FeeEnginePayload = async ({
  config,
  currentProfileId,
  userInfo,

...
const tempDirectory = mkdtempSync(
  join(tmpdir(), "service-entry-gate-final-submission-tests-"),
);
const bundlePath = join(
  tempDirectory,
  "serviceEntryGateFinalSubmission.test.mjs",
);
...
try {
  execFileSync(
    esbuildPath,
    [
      "scripts/serviceEntryGateFinalSubmission.test.ts",
      "--bundle",
      "--platform=node",
      "--format=esm",
      '--define:import.meta.env.VITE_SERVICE_ENTRY_GATE_DEFAULT_ENABLED="false"',

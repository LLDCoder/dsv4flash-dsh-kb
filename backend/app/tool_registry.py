...
DEFAULT_TOOL_DEFINITIONS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "endTime": {"type": "string"},
                "applicationStatusId": {"type": ["string", "integer"]},
                "applicationTypeId": {"type": ["string", "integer"]},
                "sortBy": {"type": "string"},
                "sortDirection": {"type": "integer", "enum": [0, 1]},
            },
        },
        "auth_strategy": "current_umc_bearer_token",
        "source": "swagger",
    ...
    {
        "tool_name": "umc.payments",
        "display_name": "List payment transactions",
        "description": "Read-only payment transaction records for the current account.",
        "operation_id": "payment_transactions",
        "http_method": "GET",
        "http_path": "/api/payment-center/transactions",
        "parameters": {
            "type": "object",
            "properties": {
                "keyWord": {"type": "string"},
